...
int main()
{
	...
	cout << "Laba_4, Yarokhmedov D., V-14" << endl << endl;
	int mass[8] = { 1,2,5,3,7,4,8,9 };
	int mass1[8] = { 1,6,3,2,6,7,8,0 };
	Trapezoid TR1;
	Trapezoid TR2(mass);
	Trapezoid TR3(mass1);
	cout << "TR3:" << endl;
	TR3.Show("TR3");
	cout<< endl;
	cout << "Зменшимо TR3 на 3 одиницi:" << endl;
	TR3 - 3;
	TR3.Show("TR3");
	cout << endl;
	...
	cout << "Помножимо TR2 на TR3:" << endl;
	TR2* TR3;
	TR2.Show("TR2");
	cout << endl;
	...
	cout << "Запишемо добуток TR2 i TR3 в TR1:" << endl;
	TR1.Show("TR1");
	return 0;
}